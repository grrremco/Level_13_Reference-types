//Deel 1
let person = {name: 'Remco', age: 42, evaluations: [7, 10, 9]};
...
//Deel 2
let selectedColor = ['groen', 'blauw', 'rood'];
selectedColor[3] = 'geel';
selectedColor[4] = 1;
selectedColor[5] = {greeting: "Hi ik ben een object"};
...
console.log(selectedColor[5].greeting);
